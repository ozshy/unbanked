...
summary(i6_reg.df$age)
table(i6_reg.df$unbanked)
...
### Start Figure 7 
# check, debit, credit, prepaid, money order (mon_adopt), BANP, OBBP, crypto, mobile_app (nbop_acnt_adopt), other_mobile_app (other_nbops_adopt), cash (csh_adopt), carry cash (carry_csh)
# check adoption
...
# cash adoption
table(i5_banked.df$csh_adopt, exclude = F)
(adopt_cash_banked_w_frac = sum(i5_banked.df[i5_banked.df$csh_adopt==1, ]$w5_banked, na.rm = T)/(sum(i5_banked.df[i5_banked.df$csh_adopt==1, ]$w5_banked, na.rm = T) + sum(i5_banked.df[i5_banked.df$csh_adopt==0, ]$w5_banked, na.rm = T)))
#
...
# cash adoption
table(i5_unbanked.df$csh_adopt, exclude = F)
(adopt_cash_unbanked_w_frac = sum(i5_unbanked.df[i5_unbanked.df$csh_adopt==1, ]$w5_unbanked, na.rm = T)/(sum(i5_unbanked.df[i5_unbanked.df$csh_adopt==1, ]$w5_unbanked, na.rm = T) + sum(i5_unbanked.df[i5_unbanked.df$csh_adopt==0, ]$w5_unbanked, na.rm = T)))
...
# adoption data frame (finalizing Fig 7 in Excel file)
(adopt_var.vec = c("Adopt_check (%)", "Adopt_debit (%)", "Adopt_credit (%)", "Adopt_prepaid (%)", "Adopt_BANP (%)", "Adopt_OBBP (%)", "Adopt_moneyorder (%)", "Adopt_crypto (%)", "Adopt_mobile (%)", "Adopt_other_mobile (%)", "Adopt_cash (%)"))

(banked_adopt.vec = c(adopt_check_banked_w_frac, adopt_debit_banked_w_frac, adopt_credit_banked_w_frac, adopt_prepaid_banked_w_frac, adopt_banp_banked_w_frac, adopt_obbp_banked_w_frac, adopt_moneyorder_banked_w_frac, adopt_crypto_banked_w_frac, adopt_mobile_banked_w_frac, adopt_other_mobile_banked_w_frac, adopt_cash_banked_w_frac))
#
(unbanked_adopt.vec = c(adopt_check_unbanked_w_frac, adopt_debit_unbanked_w_frac, adopt_credit_unbanked_w_frac, adopt_prepaid_unbanked_w_frac, adopt_banp_unbanked_w_frac, adopt_obbp_unbanked_w_frac, adopt_moneyorder_unbanked_w_frac, adopt_crypto_unbanked_w_frac, adopt_mobile_unbanked_w_frac, adopt_other_mobile_unbanked_w_frac, adopt_cash_unbanked_w_frac))
#
